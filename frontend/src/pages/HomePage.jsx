  ...
  return (
    <div className="min-h-screen bg-black">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-28 md:pt-0">
        ...
        <a href="tel:6674000092" className="hidden md:flex absolute bottom-8 right-8 glass px-6 py-4 items-center gap-4 hover:border-white transition-colors z-10">
          <div className="w-12 h-12 rounded-full bg-white flex items-center justify-center"><Phone className="w-5 h-5 text-black" /></div>
          <div><p className="text-white/60 text-xs uppercase tracking-wider">Call Now</p><p className="text-white font-semibold text-lg">(667) 400-0092</p></div>
        </a>
      </section>
      ...
      <section className="relative py-20 md:py-32 overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            ...
            <a href="tel:6674000092" className="inline-flex items-center justify-center gap-2 border border-white text-white px-8 py-4 font-bold uppercase tracking-wider hover:bg-white hover:text-black transition-all text-sm"><Phone className="w-4 h-4" /> (667) 400-0092</a>
          </div>
        </div>
      </section>
